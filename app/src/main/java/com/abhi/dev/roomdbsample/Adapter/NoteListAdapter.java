package com.abhi.dev.roomdbsample.Adapter;
...
import com.abhi.dev.roomdbsample.EditNoteActivity;
import com.abhi.dev.roomdbsample.Entities.Note;
import com.abhi.dev.roomdbsample.MainActivity;
import com.abhi.dev.roomdbsample.R;
...
public class NoteListAdapter extends RecyclerView.Adapter<NoteListAdapter.NoteViewHolder> {
    ...
    public NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = layoutInflater.inflate(R.layout.list, parent, false);
